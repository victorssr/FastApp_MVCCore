...
namespace FastApp_MVCCore.Controllers
{
    public class ProfessoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,TipoProfessor,Documento,Ativo,Id,DataCadastro,DataUltimaAlteracao")] Professor professor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Nome,TipoProfessor,Documento,Ativo,Id,DataCadastro,DataUltimaAlteracao")] Professor professor)
        {
            if (id != professor.Id)
            {
                return NotFound();
